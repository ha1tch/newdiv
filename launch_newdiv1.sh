...
$ZESARUX  --noconfigfile   --machine 48k   --enable-mmc   --enable-divmmc-ports   --enable-divmmc-paging   --enable-divmmc   --divmmc-rom newdiv/ESXMMC.BIN   --mmc-file newdiv1/newdiv1.mmc

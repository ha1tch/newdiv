...
_plugin_info:
	...
	defb 0				; flags2
	defb ".MG1 screen plugin - pulsar/bob_fossil", $0
...
_plugin_start:
	...
	ld a, (bc)			; get current ram bank
					; load value into mg1_viewer.bin
...
_plugin_size:
	...
	ld bc, MG1_SIZE			; check if filesize HL == 19456
	or a
	sbc hl, bc
...
_plugin_esxdos_page_restore:
	...
	ld a, (_plugin_file_handle)		; load handle into mg1_viewer.bin
...
_plugin_reloc_start:
	...
	; mg1_viewer.asm needs to be built at origin $6400
	; so we assemble it there and include it as a binary block
	BINARY "mg1_viewer.bin"
